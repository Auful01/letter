        ...
        <ul style="list-style: none">
            <li>
                <div class="row">
                    ...
                    <div class="col">: {{ $sk->identitas->nama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">NIK</div>
                    <div class="col">: {{ $sk->identitas->nik}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Tempat/Tanggal Lahir</div>
                    <div class="col">: {{ $sk->identitas->ttl}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Jenis Kelamin</div>
                    <div class="col">: {{ $sk->identitas->kelamin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Agama</div>
                    <div class="col">: {{ $sk->identitas->agama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Pekerjaan</div>
                    <div class="col">: {{ $sk->identitas->pekerjaan}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Status</div>
                    <div class="col">: {{ $sk->identitas->status_kawin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Alamat</div>
                    <div class="col">: {{ $sk->identitas->alamat}}</div>
                </div>
            </li>
        </ul>

        <p>
            Selanjutnya menerangkan bahwa orang tersebut benar-benar mempunyai {{$sk->nama_usaha}} yang bertempat di {{$sk->alamat_usaha}}. Yang ditujukan untuk {{$sk->tujuan}}. Dalam keperluan {{$sk->perlu}}.
        </p>
        <p>

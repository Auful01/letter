        ...
        <ul style="list-style: none">
            <li>
                <div class="row">
                    ...
                    <div class="col">: {{ $skn->nama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">NIK</div>
                    <div class="col">: {{ $skn->nik}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Tempat/Tanggal Lahir</div>
                    <div class="col">: {{ $skn->ttl}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Jenis Kelamin</div>
                    <div class="col">: {{ $skn->kelamin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Agama</div>
                    <div class="col">: {{ $skn->agama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Pekerjaan</div>
                    <div class="col">: {{ $skn->pekerjaan}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Status</div>
                    <div class="col">: {{ $skn->status_kawin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Alamat</div>
                    <div class="col">: {{ $skn->alamat}}</div>
                </div>
            </li>
        </ul>

        <p>
            Selanjutnya menerangkan bahwa orang tersebut benar-benar mempunyai {{$skn->nama_usaha}} yang bertempat di {{$skn->alamat_usaha}}. Yang ditujukan untuk {{$skn->tujuan}}. Dalam keperluan {{$skn->perlu}}.
        </p>
        <p>

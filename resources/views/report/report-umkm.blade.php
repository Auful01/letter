    ...
    <div class="container" style="margin-left: 4cm;margin-top: 3cm;margin-bottom: 3cm;margin-right: 3cm;">
        ...
        <ul style="list-style: none">
            <li>
                <div class="row">
                    ...
                    <div class="col">: {{ $umkm->identitas->nama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">NIK</div>
                    <div class="col">: {{ $umkm->identitas->nik}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Tempat/Tanggal Lahir</div>
                    <div class="col">: {{ $umkm->identitas->ttl}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Jenis Kelamin</div>
                    <div class="col">: {{ $umkm->identitas->kelamin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Agama</div>
                    <div class="col">: {{ $umkm->identitas->agama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Pekerjaan</div>
                    <div class="col">: {{ $umkm->identitas->pekerjaan}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Status</div>
                    <div class="col">: {{ $umkm->identitas->status_kawin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Alamat</div>
                    <div class="col">: {{ $umkm->identitas->alamat}}</div>
                </div>
            </li>
        </ul>

        <p>
            Selanjutnya menerangkan bahwa orang tersebut benar-benar mempunyai {{$umkm->nama_usaha}} yang bertempat di {{$umkm->alamat_usaha}}. Yang ditujukan untuk {{$umkm->tujuan}}. Dalam keperluan {{$umkm->perlu}}.
        </p>
        <p>
        ...
        <div class="row d-flex justify-content-right">
            ...
            <div class="col-md-4">
                ...
                <p> {{ $ttd->jabatan->jabatan }}, Desa Sidodadi</p>

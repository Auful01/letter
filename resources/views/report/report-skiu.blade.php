        ...
        <ul style="list-style: none">
            <li>
                <div class="row">
                    ...
                    <div class="col">: {{ $skiu->identitas->nama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">NIK</div>
                    <div class="col">: {{ $skiu->identitas->nik}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Tempat/Tanggal Lahir</div>
                    <div class="col">: {{ $skiu->identitas->ttl}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Jenis Kelamin</div>
                    <div class="col">: {{ $skiu->identitas->kelamin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Agama</div>
                    <div class="col">: {{ $skiu->identitas->agama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Pekerjaan</div>
                    <div class="col">: {{ $skiu->identitas->pekerjaan}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Status</div>
                    <div class="col">: {{ $skiu->identitas->status_kawin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Alamat</div>
                    <div class="col">: {{ $skiu->identitas->alamat}}</div>
                </div>
            </li>
        </ul>

        <p>
            Selanjutnya menerangkan bahwa orang tersebut benar-benar mempunyai {{$skiu->nama_usaha}} yang bertempat di {{$skiu->alamat_usaha}}. Yang ditujukan untuk {{$skiu->tujuan}}. Dalam keperluan {{$skiu->perlu}}.
        </p>
        <p>

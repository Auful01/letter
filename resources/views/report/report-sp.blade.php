        ...
        <ul style="list-style: none">
            <li>
                <div class="row">
                    ...
                    <div class="col">: {{ $sp->identitas->nama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">NIK</div>
                    <div class="col">: {{ $sp->identitas->nik}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Tempat/Tanggal Lahir</div>
                    <div class="col">: {{ $sp->identitas->ttl}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Jenis Kelamin</div>
                    <div class="col">: {{ $sp->identitas->kelamin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Agama</div>
                    <div class="col">: {{ $sp->identitas->agama}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Pekerjaan</div>
                    <div class="col">: {{ $sp->identitas->pekerjaan}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Status</div>
                    <div class="col">: {{ $sp->identitas->status_kawin}}</div>
                </div>
            </li>
            <li>
                <div class="row">
                    <div class="col-md-3">Alamat</div>
                    <div class="col">: {{ $sp->identitas->alamat}}</div>
                </div>
            </li>
        </ul>

        <p>
            Selanjutnya menerangkan bahwa orang tersebut benar-benar mempunyai {{$sp->nama_usaha}} yang bertempat di {{$sp->alamat_usaha}}. Yang ditujukan untuk {{$sp->tujuan}}. Dalam keperluan {{$sp->perlu}}.
        </p>
        <p>

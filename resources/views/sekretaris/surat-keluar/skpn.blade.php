        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row mb-4">
                        ...
                        <div class="col">
                            <textarea name="alamat" class="form-control" id="tujuan" cols="30" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-md-3  text-right">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col">
                        <input type="date" class="form-control" name="tanggal_nikah" id="tanggal_nikah">
                    </div>
                </div>
            </div>
            ...
            <div class="text-right">
                <button class="btn btn-sm btn-primary" id="save-skpn"> <i class="fas fa-check"></i> Simpan</button>
...
@section('script')
    <script>
        ...
        $('#save-skpn').on('click', function() {
            ...
            var tgl_nikah = $('#tanggal_nikah').val()

    ...
    <div class="card-body">
        ...
        <h5 style="border-left: 4px solid rgb(145, 145, 145)">&nbsp;&nbsp;Keterangan</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col">
                                <textarea name="alamat_usaha" class="form-control" id="alamat_usaha" cols="30" rows="2"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-right">
                    <button class="btn btn-sm btn-primary" id="save-skiu"> <i class="fas fa-check"></i> Simpan</button>
